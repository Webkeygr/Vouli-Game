...
lib.ssMetadata = [
		{name:"antik_ENG_atlas_1", frames: [[1047,940,114,42],[1047,858,507,80],[0,0,1692,784],[1649,786,154,174],[1047,786,600,70],[572,1261,1214,41],[0,1468,1362,41],[0,786,570,680],[572,786,473,473]]}
];
...
(lib.CachedBmp_39 = function() {
	this.initialize(ss["antik_ENG_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(63.45,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(63.5,0,253.5,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(299.05,11.2,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_34();
	this.instance_1.setTransform(336.65,11.2,0.5,0.5);
...
// stage content:
(lib.antik_ENG = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/eng_antik1.mp3", "intro");
			createjs.Sound.registerSound("sounds/eng_antik2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/eng_antik3.mp3", "oles");
			createjs.Sound.registerSound("sounds/eng_antik4.mp3", "telos_xronou");
			createjs.Sound.registerSound("sounds/eng_ant_c14.mp3", "first_pair");
			createjs.Sound.registerSound("sounds/eng_ant_c15.mp3", "other_pair");
			createjs.Sound.registerSound("sounds/eng_ant_c16.mp3", "no_pair");
			...
			preload1.loadFile("xml/eng_antik.xml");
		}
		...
		function fortose_eikona(poio_aa,se_poia_karta){
			...
			preload.loadFile("img/eng_img_"+poio_aa+".png");
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1618212387390", id:"background_black"},
		{src:"images/antik_ENG_atlas_1.png?1618212387366", id:"antik_ENG_atlas_1"}
	],
	preloads: []
};
