...
lib.ssMetadata = [
		{name:"simaies_ENG_atlas_1", frames: [[1396,962,114,42],[475,890,763,80],[0,0,1740,888],[1240,962,154,174],[1240,890,600,70],[1512,962,114,42],[0,1365,1682,41],[0,890,473,473]]}
];
...
(lib.CachedBmp_71 = function() {
	this.initialize(ss["simaies_ENG_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-64.5,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(-64.5,0,381.5,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(216,11.2,0.5,0.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(640,21.35);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape}]},1).wait(1));

	// Layer_3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("Ehj/ADIIAAmPMDH/AAAIAAGPg");
...
// stage content:
(lib.simaies_ENG = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/eng_flag1.mp3", "intro");
			createjs.Sound.registerSound("sounds/eng_flag2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/eng_flag3.mp3", "bravo");
			createjs.Sound.registerSound("sounds/eng_flag_c25.mp3", "wrong");
			createjs.Sound.registerSound("sounds/eng_flag4.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/eng_simaies.xml");
		}
		function patise(e){
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1618212468470", id:"background_black"},
		{src:"images/simaies_ENG_atlas_1.png?1618212468431", id:"simaies_ENG_atlas_1"}
	],
	preloads: []
};
