...
lib.ssMetadata = [
		{name:"teliko_ENG_atlas_1", frames: [[0,0,1657,911],[0,1387,1254,568],[0,913,1720,472]]},
		{name:"teliko_ENG_atlas_2", frames: [[1256,475,578,80],[0,0,1254,568],[1666,722,2,42],[1416,832,572,42],[1627,634,266,42],[1666,678,266,42],[1627,557,253,75],[0,832,706,129],[0,701,718,129],[0,570,818,129],[820,570,805,129],[708,832,706,129],[720,701,718,129],[1440,701,224,104],[1256,0,473,473]]}
];
...
(lib.CachedBmp_16 = function() {
	this.initialize(ss["teliko_ENG_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_15 = function() {
	this.initialize(ss["teliko_ENG_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(28.2,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(28.2,0,289,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(346.55,218,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_14();
	this.instance_2.setTransform(366.55,218,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(-379.75,19.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(-379.325,19.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-179.55,-32.3,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_2();
	this.instance_1.setTransform(-176.4,-32.3,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(-201.2,-32.3,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_4();
	this.instance_3.setTransform(-204.4,-32.3,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_5();
	this.instance_4.setTransform(-179.55,-32.3,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_6();
	this.instance_5.setTransform(-176.4,-32.3,0.5,0.5);

	this.instance_6 = new lib.CachedBmp_7();
	this.instance_6.setTransform(-63.25,-20.3,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(193,455,0.6,0.6);
	...
	this.instance_1.setTransform(225.7,68.6,0.5,0.5);
...
// stage content:
(lib.teliko_ENG = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/eng_game1.mp3", "intro");
			createjs.Sound.registerSound("sounds/eng_game2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/eng_game3.mp3", "win_1");
			createjs.Sound.registerSound("sounds/eng_game4.mp3", "win_2");
			createjs.Sound.registerSound("sounds/eng_tel_bravo_1.mp3", "bravo_1");
			createjs.Sound.registerSound("sounds/eng_tel_bravo_2.mp3", "bravo_2");
			createjs.Sound.registerSound("sounds/eng_tel_wrong_1.mp3", "wrong_1");
			createjs.Sound.registerSound("sounds/eng_tel_wrong_2.mp3", "wrong_2");
			createjs.Sound.registerSound("sounds/eng_tel_telos_1.mp3", "telos_1");
			createjs.Sound.registerSound("sounds/eng_tel_telos_2.mp3", "telos_2");
		...
		//	the_mcs.kapaki.addEventListener("click",tipota);
			...
			preload1.loadFile("xml/eng_teliko.xml");
		...
		function start_the_game(e) {
			var lezantes=["1st team","2nd team "];
			for (yy=0;yy<2;yy++) {
		...
		function display_erotisi() {
			var oititloi=["Introductory question","1st scene: The oath of the revolutionaries in Vostitsa","2nd scene: The uprising in Patras","3rd scene: National Assembly in Kalamata","4th scene: The glory of the Patriarch","5th scene: Revolution of the Greeks against the Turks","6th scene: Victories of the Greeks on land and at sea","7th scene: National Assembly in Epidaurus","8th scene: Kanaris sets fire to the Turkish fleet in Chios","9th scene: Mavrokordatos defends Messolonghi","10th scene: Botsaris attacks the Turkish camp in Karpenisi","11th scene: Victory hovers over sunken ships",
		"12th scene: Plunder of the Peloponnese by Ibrahim Pasha","13th scene: Personalization of the city of Messolonghi","14th scene: The Treaty of London","15th scene: Victory of the Greeks against the Turks at sea","16th scene: Naval battle of Navarino","17th scene: Personalization of Greece","18th scene: The founding of «Panhellenion» by Kapodistrias","19th scene: Louis I presents Otto to the Greeks","20th scene: The arrival of Otto in Nafplio"];	
			var alla=[-1,-1,-1];
			var tix,tix_erot;
			do {
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1618212360593", id:"background_black"},
		{src:"images/zoforos.jpg?1618212360593", id:"zoforos"},
		{src:"images/zoforos_black.jpg?1618212360593", id:"zoforos_black"},
		{src:"images/teliko_ENG_atlas_1.png?1618212360554", id:"teliko_ENG_atlas_1"},
		{src:"images/teliko_ENG_atlas_2.png?1618212360554", id:"teliko_ENG_atlas_2"}
	],
	preloads: []
};
