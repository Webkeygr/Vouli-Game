...
lib.ssMetadata = [
		{name:"tipos_ENG_atlas_1", frames: [[475,1003,114,42],[475,673,606,80],[0,0,1684,628],[475,827,154,174],[475,755,600,70],[475,1047,114,42],[475,630,1210,41],[0,1105,1609,41],[0,630,473,473]]}
];
...
(lib.CachedBmp_87 = function() {
	this.initialize(ss["tipos_ENG_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// answer
	this.answer = new cjs.Text("Εγκώμιο για τον ναύαρχο Ανδρέα Μιαούλη και τους λοιπούς πλοιάρχους και ναύτες του ελληνικού στόλου, με αφορμή σχετική συγχαρητήρια επιστολή του Γεωργίου Κουντουριώτη ως εκπροσώπου της Διοίκησης", "normal 500 18px 'Fira Sans Condensed'", "#FFFFFF");
	this.answer.name = "answer";
	this.answer.lineHeight = 27;
	this.answer.lineWidth = 518;
	this.answer.parent = this;
	this.answer.setTransform(12,-54.9);
	...
	// background
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(102,102,102,0.098)").s().p("EguzAKeIAA07MBdnAAAIAAU7g");
	this.shape.setTransform(299.575,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("EguzAKeIAA07MBdnAAAIAAU7g");
...
p.nominalBounds = new cjs.Rectangle(0,-67,599.2,135.9);
...
}).prototype = getMCSymbolPrototype(lib.the_backgr, new cjs.Rectangle(-27,-15,1333.5,750.1), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.keimeno = new cjs.Text("Εγκώμιο για τον ναύαρχο Ανδρέα Μιαούλη και τους λοιπούς πλοιάρχους και ναύτες του ελληνικού στόλου, με αφορμή σχετική συγχαρητήρια επιστολή του Γεωργίου Κουντουριώτη ως εκπροσώπου της Διοίκησης\nΕγκώμιο για τον ναύαρχο Ανδρέα Μιαούλη και τους λοιπούς πλοιάρχους και ναύτες του ελληνικού στόλου, με αφορμή σχετική συγχαρητήρια επιστολή του Γεωργίου Κουντουριώτη ως εκπροσώπου της Διοίκησης", "italic 700 12px 'Fira Sans Condensed'", "#FFFFFF");
	this.keimeno.name = "keimeno";
	this.keimeno.lineHeight = 18;
	this.keimeno.lineWidth = 1032;
	this.keimeno.parent = this;
	this.keimeno.setTransform(2,0);
	if(!lib.properties.webfonts['Fira Sans Condensed']) {
		lib.webFontTxtInst['Fira Sans Condensed'] = lib.webFontTxtInst['Fira Sans Condensed'] || [];
...
}).prototype = getMCSymbolPrototype(lib.sxolia, new cjs.Rectangle(0,-2,1036.4,40.8), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(14.1,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(14.1,0,303,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(237.45,11.2,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_81();
	this.instance_1.setTransform(338.95,11.2,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.to_sxolio.setTransform(-217.65,-36,1,1,0,0,0,413.7,11);
...
if (reversed == null) { reversed = false; }
	...
	this.mc2.name = "mc2";
	this.mc2.setTransform(981.25,337.8,1,1,0,0,0,261.1,62.9);

	this.mc1 = new lib.themc();
	this.mc1.name = "mc1";
	this.mc1.setTransform(981.25,191.15,1,1,0,0,0,261.1,62.9);

	this.mc4 = new lib.themc();
	this.mc4.name = "mc4";
	this.mc4.setTransform(981.25,631.15,1,1,0,0,0,261.1,62.9);

	this.mc3 = new lib.themc();
	this.mc3.name = "mc3";
	this.mc3.setTransform(981.25,484.45,1,1,0,0,0,261.1,62.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.mc3},{t:this.mc4},{t:this.mc1},{t:this.mc2}]}).wait(1));
...
// stage content:
(lib.tipos_ENG = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/eng_typ1.mp3", "intro");
			createjs.Sound.registerSound("sounds/eng_typ2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/eng_tip_bravo_1.mp3", "bravo_1");
			createjs.Sound.registerSound("sounds/eng_tip_bravo_2.mp3", "bravo_2");
			createjs.Sound.registerSound("sounds/eng_tip_wrong_1.mp3", "wrong_1");
			createjs.Sound.registerSound("sounds/eng_tip_wrong_2.mp3", "wrong_2");
			createjs.Sound.registerSound("sounds/eng_tip_wrong_3.mp3", "wrong_3");
			createjs.Sound.registerSound("sounds/eng_tip_telos_xronou.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/eng_tipos.xml");
		}
		function patise(e){
		...
		function paper2(e) {
			the_apok.eikona.x=213;
			the_apok.eikona.y=2;
			the_apok.eikona_back.x=213;
			the_apok.eikona_back.y=2;
			createjs.Tween.get(the_apok.eikona).to({alpha: 1,scale:0.41}, 300, createjs.Ease.none());
			createjs.Tween.get(the_apok.eikona_back).to({alpha: 1,scale:0.41}, 300, createjs.Ease.none());
		...
		function paper3(e) {
			...
			the_apok.eikona_back.scale=oi_erotiseis[1][quest_numbs[ask_index]]/100;
			the_apok.eikona.scale=oi_erotiseis[1][quest_numbs[ask_index]]/100;
		...
		function zooms_in(e) {
			createjs.Tween.get(the_apok).to({scale: 2.8}, 300, createjs.Ease.none());
		...
		//	createjs.Tween.get(the_backgr).to({alpha: 1}, 300, createjs.Ease.none());
			quest_numbs=[];
			for (xx=0;xx<10;xx++) {
		...
		//			oi_apant[xx].soston=1;
				...
				oi_apant[xx].answer.text=oi_erotiseis[4][alla[xx]];
				oi_apant[xx].answer.y=-57+(126-oi_apant[xx].answer.getMeasuredHeight())/2;
			}
			the_bara.to_sxolio.keimeno.text=oi_erotiseis[4][quest_numbs[ask_index]]+"\n"+oi_erotiseis[5][quest_numbs[ask_index]];
			the_mcs.visible=true;
		...
		function deixe_sosto() {
			...
			for (xx=0;xx<oi_apant.length;xx++) {
				if (oi_apant[xx].soston==1) {
					...
					createjs.Tween.get(oi_apant[xx]).to({y: oi_apant[1].y+(oi_apant[2].y-oi_apant[1].y)/2}, 300, createjs.Ease.none());
				} else {
					oi_apant[xx].gotoAndStop(0);
		...
		function handleFileComplete1(event) {
			...
			var epikefs = ["aa", "the_scale", "the_x", "the_y", "ekfon", "sxolio"];
			var templist;
		...
		function fortose_apokoma(poio_aa){
			...
			preload.loadFile("img/tip_"+poio_aa+".png");
			console.log("img/tip_"+poio_aa+".png");
		};
		function fortothike_apokoma(event) {
			...
			the_apok.eikona.scaleX=oi_erotiseis[1][quest_numbs[ask_index]]/100;
			the_apok.eikona.scaleY=oi_erotiseis[1][quest_numbs[ask_index]]/100;
			the_apok.eikona.x=oi_erotiseis[2][quest_numbs[ask_index]];	
			the_apok.eikona.y=oi_erotiseis[3][quest_numbs[ask_index]];	
			the_apok.eikona.thex=oi_erotiseis[2][quest_numbs[ask_index]];	
			the_apok.eikona.they=oi_erotiseis[3][quest_numbs[ask_index]];	
		...
		function fortose_eikona(poio_aa){
			...
			preload.loadFile("img/tip_"+poio_aa+".jpg");
		};
		function fortothike_eikona(event) {
			...
			the_apok.eikona_back.scaleX=oi_erotiseis[1][quest_numbs[ask_index]]/100;
			the_apok.eikona_back.scaleY=oi_erotiseis[1][quest_numbs[ask_index]]/100;
			the_apok.eikona_back.x=oi_erotiseis[2][quest_numbs[ask_index]];	
			the_apok.eikona_back.y=oi_erotiseis[3][quest_numbs[ask_index]];	
			the_apok.eikona_back.thex=oi_erotiseis[2][quest_numbs[ask_index]];	
			the_apok.eikona_back.they=oi_erotiseis[3][quest_numbs[ask_index]];	
	...
	// background
	this.instance = new lib.the_backgr();
	this.instance.setTransform(640,359.9,1,1,0,0,0,640,359.9);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1618212521728", id:"background_black"},
		{src:"images/tipos_ENG_atlas_1.png?1618212521693", id:"tipos_ENG_atlas_1"}
	],
	preloads: []
};
