...
lib.ssMetadata = [
		{name:"filiki_atlas_1", frames: [[1082,734,114,42],[475,806,449,80],[0,0,1646,732],[926,806,168,174],[475,734,605,70],[475,888,114,42],[0,734,473,473]]}
];
...
(lib.CachedBmp_25 = function() {
	this.initialize(ss["filiki_atlas_1"]);
	this.gotoAndStop(0);
...
p.nominalBounds = new cjs.Rectangle(0,0,2188,146);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(92.4,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(92.4,0,224.49999999999997,40), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
	this.shape.setTransform(-0.0111,0.0284,1.6725,1.6725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(0,0.025);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(93,11.6,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.kodikop}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.apokodikop}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// lezanta
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(200.55,35.925);
...
// stage content:
(lib.filiki = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/fil1.mp3", "intro");
			createjs.Sound.registerSound("sounds/fil2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/fil_c28.mp3", "bravo");
			createjs.Sound.registerSound("sounds/fil_c8.mp3", "wrong");
			createjs.Sound.registerSound("sounds/fil_c22.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/filiki.xml");
		}
		function sbise(e) {
			console.log(typed);
			createjs.Sound.stop();
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/CachedBmp_37.png?1617868981840", id:"CachedBmp_37"},
		{src:"images/CachedBmp_36.png?1617868981840", id:"CachedBmp_36"},
		{src:"images/CachedBmp_35.png?1617868981840", id:"CachedBmp_35"},
		{src:"images/background_black.jpg?1617868981840", id:"background_black"},
		{src:"images/filiki_atlas_1.png?1617868981790", id:"filiki_atlas_1"}
	],
	preloads: []
};
