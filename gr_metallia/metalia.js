...
lib.ssMetadata = [
		{name:"metalia_atlas_1", frames: [[1582,258,114,42],[1582,0,458,80],[0,0,1580,368],[1582,82,168,174],[1047,370,605,70],[1582,302,114,42],[0,942,1771,42],[0,370,570,570],[572,370,473,473]]}
];
...
(lib.CachedBmp_52 = function() {
	this.initialize(ss["metalia_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(88.2,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(88.2,0,229,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(197.25,11.2,0.5,0.5);
...
// stage content:
(lib.metalia = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/met1.mp3", "intro");
			createjs.Sound.registerSound("sounds/met2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/met_c6.mp3", "bravo");
			createjs.Sound.registerSound("sounds/met_c26.mp3", "wrong_1");
			createjs.Sound.registerSound("sounds/met_c27.mp3", "wrong_2");
			createjs.Sound.registerSound("sounds/met_c11.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/metallia.xml");
		}
		function go_back(e) {
			flag_tick=0;
			set_the_bara([1,0,0,0,0,0,1]);
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1617869083313", id:"background_black"},
		{src:"images/metalia_atlas_1.png?1617869083287", id:"metalia_atlas_1"}
	],
	preloads: []
};
