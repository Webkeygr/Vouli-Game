...
lib.ssMetadata = [
		{name:"syntagmata_atlas_1", frames: [[1824,0,114,42],[475,526,800,80],[0,0,1652,524],[1654,0,168,174],[1277,526,605,70],[1824,44,114,42],[475,652,970,42],[475,608,1429,42],[0,526,473,473]]}
];
...
(lib.CachedBmp_68 = function() {
	this.initialize(ss["syntagmata_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-83.25,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(-83.2,0,400,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(282.75,11.2,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_62();
	this.instance_1.setTransform(397.6,11.2,0.5,0.5);
...
// stage content:
(lib.syntagmata = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/synt1.mp3", "intro");
			createjs.Sound.registerSound("sounds/synt2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/synt_bravo_1.mp3", "bravo_1");
			createjs.Sound.registerSound("sounds/synt_bravo_2.mp3", "bravo_2");
			createjs.Sound.registerSound("sounds/synt_wrong_1.mp3", "wrong_1");
			createjs.Sound.registerSound("sounds/synt_wrong_2.mp3", "wrong_2");
			createjs.Sound.registerSound("sounds/synt_telos_xronou.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/syntagmata.xml");
		}
		function patise(e){
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1617869258692", id:"background_black"},
		{src:"images/syntagmata_atlas_1.png?1617869258662", id:"syntagmata_atlas_1"}
	],
	preloads: []
};
