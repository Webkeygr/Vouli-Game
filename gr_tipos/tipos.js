...
lib.ssMetadata = [
		{name:"tipos_atlas_1", frames: [[1076,674,114,42],[475,674,599,80],[0,0,1684,628],[475,828,168,174],[475,756,605,70],[475,1004,114,42],[475,630,1191,42],[0,1105,1643,42],[0,630,473,473]]}
];
...
(lib.CachedBmp_92 = function() {
	this.initialize(ss["tipos_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(17.5,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.otitlos, new cjs.Rectangle(17.5,0,299.5,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(228.95,11.2,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_86();
	this.instance_1.setTransform(341.9,11.2,0.5,0.5);
...
// stage content:
(lib.tipos = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function start_up() {
			...
			createjs.Sound.registerSound("sounds/typ1.mp3", "intro");
			createjs.Sound.registerSound("sounds/typ2.mp3", "odigies");
			createjs.Sound.registerSound("sounds/tip_bravo_1.mp3", "bravo_1");
			createjs.Sound.registerSound("sounds/tip_bravo_2.mp3", "bravo_2");
			createjs.Sound.registerSound("sounds/tip_wrong_1.mp3", "wrong_1");
			createjs.Sound.registerSound("sounds/tip_wrong_2.mp3", "wrong_2");
			createjs.Sound.registerSound("sounds/tip_wrong_3.mp3", "wrong_3");
			createjs.Sound.registerSound("sounds/tip_telos_xronou.mp3", "telos_xronou");
			...
			preload1.loadFile("xml/tipos.xml");
		}
		function patise(e){
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/background_black.jpg?1617870022183", id:"background_black"},
		{src:"images/tipos_atlas_1.png?1617870022155", id:"tipos_atlas_1"}
	],
	preloads: []
};
